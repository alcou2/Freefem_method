...
figure(); hold on;
xlabel('Number of elements in the fluid domain)');
ylabel('1st mode frequency');

plot(sizeF,real(EigFreq_bar(1,:)),'b');
...
RL1 = 5; %Length of domain in front of the plate (in plate length unit)
RL2 = [0.1,0.5,1,3,5,10]; %Length of domain behind of the plate (in plate length unit)
...
plot(sizeF,real(EigFreq_bar(3,:)),'b');
